...
<html>
    <head>
         <title>YeP</title>
            ...
            <link type = "text/css" href ="add_hobby.css" rel = "stylesheet" >
...
<div class="form">
	<form action="<?=$_SERVER['PHP_SELF']?>" method="post" class="form">
		<h3> <input type = "text" name="hobby_name" > </h3>
	<br>
...
## query database
	...
	$username = $_SESSION['username']; 
		...
		$sql = "INSERT  INTO `hobbies` (`hobby_name`, `hobbies_username`) 
				VALUES ('{$hobby_name}', '{$username}')";
