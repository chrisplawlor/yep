...
<html>
    <head>
         <title>YeP</title>
            ...
            <link type = "text/css" href ="hobbies.css" rel = "stylesheet" >
...
<h3>My Hobbies</h3><a href="add_hobby.php">
...
<!-- The HTML registration form -->
	...
	$sql = "SELECT *  FROM hobbies WHERE hobbies_username = '$username' ";
	...
	<h4> <?php echo $record['hobby_name']; ?></h4></div>
	<?php
